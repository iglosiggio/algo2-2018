...
private:
	...
	Busqueda buscar(const T& valor, Nodo* raiz) const;
	Busqueda maximoDesde(Nodo* raiz) const;
	Busqueda minimoDesde(Nodo* raiz) const;

	Nodo* minimo(Nodo* nodo) const;
	Nodo* maximo(Nodo* nodo) const;
	unsigned int cardinal(const Nodo* nodo) const;

	void reventarDesde(Nodo* nodo);
